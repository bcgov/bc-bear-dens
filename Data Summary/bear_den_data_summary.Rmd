...
model0o <- glm(den_status_binary ~ dist_lt40 * region + age + year, data = dat, family = binomial)

model1a <- glm(den_status_binary ~ year + region + v_prop_forest_60m + dist_from_edge * age + road_density_m2, data = dat, family = binomial)
model1b <- glm(den_status_binary ~ year + region + v_prop_forest_60m + dist_road * age, data = dat, family = binomial)
...
```{r den status v func entrance width, dev.args=list(bg="transparent")}
f_full |>
